		...
		<div id="idx_container">
			<div id="idxA">
				<video preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
					<source src="https://www.doome.net/img/index/mov01.mp4">
				</video>
			...
			<div id="idxB">
				<div>
					...
					<ul>
						<li>
							<img src="img/index/idxB1.png" alt="사회적기업">
							<h5>사회적기업</h5>
						...
						<li>
							<img src="img/index/idxB2.png" alt="전라북도지사 인증상품">
							<h5>전라북도지사 인증상품</h5>
						...
						<li>
							<img src="img/index/idxB3.png" alt="전주시 인증상품">
							<h5>전주시 인증상품</h5>
			...
			<div id="idxD">
				<div>
					<h4>PARTNERSHIP</h4>
		            <p><span>두메산골영농조합법인의 우수한 품질의 닭고기와 오리고기는</span> <span>전라북도 완주군에 위치하고 있는 현대자동차 공장, KCC공장, 전북대학교 생활관, 전주동물원등에 납품되고 있으며</span> <span>식재료 검수가 까다롭기도 유명한 전주시와 완주군의 초·중·고등학교에 우리 소중한 아이들이 먹을 건강한 식재료를 책임지고 있습니다.</span> <span>이마트, 농협하나로마트, 로컬푸드등에서도 두메산골영농조합법인의 제품을 만나실 수 있습니다.</span></p>
					<ul>
		            ...
		            <a href="/page.jsp?menu_id=15" class="bt2">납품문의</a>
				</div>
			</div>
		</div>
	</div>
