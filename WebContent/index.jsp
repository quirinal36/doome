	...
	<div id="idx_container_wrap">
		<div id="idx_container">
			...
			<div id="idxD">
				<div>
					<h4>partnership</h4>
		            <p>두메산골영농조합법인의 우수한 품질의 닭고기와 오리고기는 전라북도 완주군에 위치하고 있는 현대자동차 공장, KCC공장, 전북대학교 생활관, 전주동물원등에 납품되고 있으며 <br/> 식재료 검수가 까다롭기도 유명한 전주시와 완주군의 초,중,고등학교에 우리 소중한 아이들이 먹을 건강한 식재료를 책임지고있습니다. <br/> 이마트, 농협하나로마트, 로컬푸드등에서도 두메산골영농조합법인의 제품을 만나실 수 있습니다.</p>
					<ul>
